...
EC-Schnorr, as the name suggests, is a Schnorr-type digital signature scheme over elliptic curve, it's [[https://blog.iuliancostan.com/post/2019-04-09-ecdsa][ECDSA]]'s little sister and [[https://blog.iuliancostan.com/post/2019-06-19-schnorr][Schnorr]]'s big brother with multiple implementations out there: maybe most widely deployed being [[https://en.wikipedia.org/wiki/EdDSA][EdDSA]] (used in [[https://web.getmonero.org][Monero]]) or the upcoming [[https://blockstream.com/2018/01/23/en-musig-key-aggregation-schnorr-signatures/][MuSig]] implementation in Bitcoin.
