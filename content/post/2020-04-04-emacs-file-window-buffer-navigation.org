...
** Intro.
   In [[https://blog.iuliancostan.com/post/2019-11-07-in-file-navigation/][Part 1]] of Emacs series I presented /the movement/ (or navigation within a single buffer/window), in this part I am going to demo /the navigation/ between multiple windows/files/buffers.
