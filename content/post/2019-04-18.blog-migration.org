...
subtitle: Blog migration
date:   2019-04-18
tags: ["blog", "jekyll", "hugo", "org-mode", "gitlab", "emacs", "literate-programming"]
markup: org
---

Since nobody wants to embrace the dark side of Wordpress anymore, the easiest way (that I knew of) to bootstrap a personal website was [[https://jekyllrb.com][Jekyll]] plus [[https://www.netlify.com][Netlify]] for deployment.
...
For those who don't know what org-mode is, I tell you, is the only organization/word/excel/presentation tool that you always wanted or needed.
