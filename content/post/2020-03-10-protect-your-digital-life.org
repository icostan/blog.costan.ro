...
This is how I keep all my data secure, encrypted and in sync between 2 phones (/ePhone/, [[https://blog.iuliancostan.com/post/2019-10-08-leaving-apple-leaving-google/][my Google-free phone]] and one /iPhone/), 2 laptops (/Lenovo/, [[https://blog.iuliancostan.com/post/2019-07-05-back-to-my-first-love/][my Linux machine]]  and a /Macbook/) and one desktop (an older iMac).
...
** C. Password manager
   I do [[https://blog.iuliancostan.com/post/2019-08-12-password-management-with-bitwarden/][password management with Bitwarden]] and this is critical piece since an attacker gets access to all your passwords so its absolutely required to have at least 2, 3 levels of protection:
   1. master password
