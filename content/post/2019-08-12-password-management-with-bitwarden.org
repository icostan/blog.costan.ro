...
The very first problem you encounter when moving from one platform to another is password management. Being an Apple user for so many years it was natural to leverage their tools and store my passwords in iCloud.
