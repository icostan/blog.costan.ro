...
*** Peggy has the private key
    ...
    First of all please see [[https://blog.iuliancostan.com/post/2019-03-26-elgamal/][ElGamal]] post to understand discrete logarithm's parameters: prime number ``p`` and generator ``g``.
...
*** Peggy knows the password
    ...
    Please see [[https://blog.iuliancostan.com/post/2019-06-19-schnorr/][Schnorr]] post to understand where these ``q`` and ``g`` parameters come from.
