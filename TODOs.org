...
*** consensus algorithms
    ...
    - threshold relay
*** volatility
    - https://www.macrodesiac.com/your-volatility-handbook/amp/?__twitter_impression=true
...
*** understanding greeks
    ...
    - vanna
    - other minor greeks
*** TODO understanding black-scholes
...
** TODO Write new blog post
    SCHEDULED: <2021-02-07 Sun +2w>
    :PROPERTIES:
    :LAST_REPEAT: [2021-02-05 Fri 12:31]
    :END:
