...
*** application management with Pacman, Yay?, Stow
*** DONE password management with Bitwarden
    CLOSED: [2019-08-13 Tue 10:55]
*** configuration management with Mackup
*** DONE 3DP project
    CLOSED: [2019-07-23 Tue 16:40]
*** cmdline verification of GnuPG signature
** Fixes
...
** Tasks
*** TODO write new blog
    SCHEDULED: <2019-08-19 Mon +2w>
    :PROPERTIES:
    :LAST_REPEAT: [2019-08-13 Tue 10:57]
    :END:
