* [[elisp:(org-projectile-open-project%20"blog")][blog]] [44/45]
  :PROPERTIES:
  :CATEGORY: blog
  :END:
*** TODO Write new blog post
    SCHEDULED: <2020-04-03 Fri +2w>
    :PROPERTIES:
    :LAST_REPEAT: [2020-03-26 Thu 17:52]
    :END:
...
*** a blog post for chapter in cryptography books
...
*** DONE fix tag links
*** fix snippets colors
*** fix code snippets, line numbers
